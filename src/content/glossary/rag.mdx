...
For the full decision framework, including when fine-tuning wins instead and when to use both together, see [RAG vs fine-tuning](/library/large-language-models/rag-vs-fine-tuning).
