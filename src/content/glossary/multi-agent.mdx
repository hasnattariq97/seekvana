...
For the full walkthrough on supervisor/worker prompting, hand-offs, and debate patterns, see [multi-agent prompting and orchestration](/library/agentic-ai/multi-agent-prompting-and-orchestration).
