...
For the full decision framework on choosing between RAG and fine-tuning, including when to use both, see [RAG vs fine-tuning](/library/large-language-models/rag-vs-fine-tuning). For the complete walkthrough of fine-tuning itself, including SFT, LoRA, and RLHF, see [LLM fine-tuning explained](/library/large-language-models/llm-fine-tuning-explained).
