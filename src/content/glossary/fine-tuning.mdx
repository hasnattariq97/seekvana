...
For the full decision framework on choosing between RAG and fine-tuning, including when to use both, see [RAG vs fine-tuning](/library/large-language-models/rag-vs-fine-tuning).
