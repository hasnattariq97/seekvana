...
For the full walkthrough, including why training incentives make models guess instead of admitting uncertainty, see [what is hallucination in AI](/library/large-language-models/what-is-hallucination-in-ai).
