...
`model` is now optional. If you don't pass one, Haiku is used automatically. You'll see this pattern constantly in [AI agent](/library/agentic-ai/what-is-an-agent) code; sensible defaults that can be overridden.
...
<Note>
 Done? You've completed Lesson 05.04. Next up: [for and while loops, reading them without panic](/library/building-with-ai/python-loops) →
