...
<Note>
  Done? You've completed Lesson 06.07. Next up: [Calling an API from JavaScript with fetch()](/library/building-with-ai/javascript-fetch-api), lesson 06.08 →, or revisit [the Getting Started path](/paths/getting-started) any time you want the full lesson sequence.
</Note>
