...
<ArticleImage src="/images/articles/building-with-ai/supabase-production-database/cover.webp" alt="A glowing database connected to the cloud with a laptop reaching toward it via a dotted line" />
