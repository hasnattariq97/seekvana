...
<ArticleImage src="/images/articles/building-with-ai/git-clone/cover-git-clone.webp" alt="A cloud repository duplicating itself to a laptop with a single arrow" />
