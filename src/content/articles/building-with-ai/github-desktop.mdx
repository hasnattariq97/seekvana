...
lessonNumber: "04.09"
faqs:
  - q: "Is GitHub Desktop free?"
    a: "Yes. GitHub Desktop is completely free and open source. There is no paid tier, all features are available to every user. You can find the source code at github.com/desktop/desktop if you want to look at how it's built."
  - q: "Does GitHub Desktop work with GitLab or Bitbucket?"
    a: "GitHub Desktop is designed primarily for GitHub repositories. You can clone and work with GitLab or Bitbucket repos locally, but features like pull request integration and issue tracking only work with GitHub. If you use GitLab or Bitbucket heavily, tools like Sourcetree or GitKraken are built to support multiple providers."
  - q: "Do I still need to learn terminal Git commands if I use GitHub Desktop?"
    a: "Yes, eventually. GitHub Desktop covers the most common operations well, but there are things it simply can't do: running Git scripts, rebasing, cherry-picking commits, and recovering from edge-case errors all require the terminal. Think of GitHub Desktop as a great starting point that will make the terminal commands easier to understand when you get there."
  - q: "Can I see merge conflicts in GitHub Desktop?"
    a: "Yes. When a merge conflict occurs, GitHub Desktop highlights the conflicting files in the Changes view and offers to open them in your editor. You resolve the conflict by editing the file (removing the conflict markers), then commit the result. It doesn't resolve conflicts for you, but it makes them easy to find and navigate."
---
