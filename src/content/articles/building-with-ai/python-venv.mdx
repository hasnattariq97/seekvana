...
<Steps>
 ...
 ```
 Your [terminal prompt](/library/building-with-ai/what-is-the-terminal) now shows `(venv)` at the start of the line. That prefix is your confirmation, everything you install from this point runs inside the isolated environment, not your global Python.
 </Step>
