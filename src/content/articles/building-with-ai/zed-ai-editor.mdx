...
<ArticleImage src="/images/articles/building-with-ai/zed-ai-editor/cover.webp" alt="Minimal code editor window with a lightning-bolt motif and a slim AI panel" priority isCover />
...
If Zed's speed-first approach isn't quite the fit, [the Windsurf AI editor](/library/building-with-ai/windsurf-ai-editor) is another VS Code fork worth trying next, built instead around an autonomous agent mode.
