...
<ArticleImage src="/images/articles/building-with-ai/supabase-setup/cover.webp" alt="Illustration of a laptop screen showing a Supabase dashboard connected to a cloud Postgres database" />
