...
Git and GitHub are not the same thing; they just sound like they are. Git is a tool you install on your computer. <a href="https://github.com" target="_blank" rel="noopener noreferrer">GitHub</a> is a website where you store and share the projects you manage with Git. In this lesson, you'll learn exactly what each one does and how they work together. (Need just the quick definition? See the [GitHub glossary entry](/glossary/github).)
...
**Git** is a [version control program](/library/building-with-ai/what-is-version-control) you install once. After that, it runs entirely on your machine.
...
<Note>
 Done? You've completed Lesson 04.02.
</Note>
