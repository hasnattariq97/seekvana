...
<Note>
You've completed Lesson 06.05. Next up: [REST APIs: GET vs POST, requests and responses](/library/building-with-ai/rest-apis-get-post) →, or revisit [the Getting Started path](/paths/getting-started) any time you want the full lesson sequence.
</Note>
