...
Cursor isn't the only option here. If raw editor speed matters more to you than deep multi-file AI features, [Zed, a faster Rust-built alternative](/library/building-with-ai/zed-ai-editor), is worth trying too.
...
<ArticleImage
  ...
  alt="Three Cursor AI modes side by side: Chat mode for asking questions, Inline Edit mode for targeted code changes, and Composer/Agent mode for assigning goals"
  caption="Cursor's three modes — Chat asks questions, Inline Edit changes a selection, and Composer/Agent takes on a whole goal."
/>
...
If none of those apply, download directly from <a href="https://cursor.com" target="_blank" rel="noopener noreferrer">cursor.com</a> and run the installer — it takes about 60 seconds.
...
<Note>
  Done? You've completed Lesson 03.02.
</Note>
