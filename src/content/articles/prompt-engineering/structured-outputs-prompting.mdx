...
<Note>
  Done? You've completed Lesson 12.08 and built your own schema-constrained extraction. Next up: [Multimodal Prompting](/library/prompt-engineering/multimodal-prompting), lesson 12.09 →
</Note>
