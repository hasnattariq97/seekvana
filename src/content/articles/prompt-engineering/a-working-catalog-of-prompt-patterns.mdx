...
<Note>
  Done? You've completed Lesson 12.01 and have a working set of prompt patterns to reach for. Next up: Decomposition and Prompt Chaining, lesson 12.02, isn't live yet. In the meantime: [explore more Launchpad lessons](/paths) →
</Note>
