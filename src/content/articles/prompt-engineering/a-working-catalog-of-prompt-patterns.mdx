...
<Note>
  Done? You've completed Lesson 12.01 and have a working set of prompt patterns to reach for. Next up: [Decomposition and Prompt Chaining](/library/prompt-engineering/decomposition-and-prompt-chaining), lesson 12.02 →
</Note>
