...
The catch is that recipes age. Models ship every few months and quietly change what your wording buys you, so a playbook needs a habit for [keeping prompts working as models evolve](/library/prompt-engineering/prompting-as-it-evolves-capstone) rather than a one-time write-up.
