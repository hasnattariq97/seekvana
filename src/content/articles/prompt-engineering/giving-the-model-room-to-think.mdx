...
<Note>
 Done? You now know when chain of thought prompting helps and when it's dead weight on a reasoning model. You've completed Lesson 11.07. Next up: [The Iteration Loop](/library/prompt-engineering/the-iteration-loop) →
</Note>
