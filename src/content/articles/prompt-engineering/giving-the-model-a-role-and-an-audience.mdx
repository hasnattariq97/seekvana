...
<Note>
Done? You've completed Lesson 11.04. Next up: [Showing vs Telling: Examples and Few-Shot](/library/prompt-engineering/showing-vs-telling-examples-and-few-shot) →
</Note>
