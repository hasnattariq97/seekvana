...
You can set your own default models for different actions in Cursor Settings, which is worth doing once you notice a pattern in what works for your kind of tasks. Picking a model is only half the autonomy question. The next lesson covers [Cursor's Agent, Plan, and Ask modes](/library/agentic-ai/cursor-modes-and-inline-edits), which control how much the model is allowed to do once you've picked it.
