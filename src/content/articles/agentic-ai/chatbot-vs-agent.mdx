...
This is what [tool use](/glossary/tool-use) means in practice. An agent has access to external systems — browsers, APIs, calendars, email, code runners — and it can reach into them to accomplish your goal.
