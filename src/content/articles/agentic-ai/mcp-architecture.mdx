...
Registering either transport with a host is a one-line command in Claude Code; see [adding MCP servers to Claude Code](/library/agentic-ai/adding-mcp-servers-to-claude-code) for the exact syntax and how project scope shares that config with a team.
