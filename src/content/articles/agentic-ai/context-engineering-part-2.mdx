...
For the hands-on workflow, exactly when to trigger a compaction pass yourself and how to verify it kept what mattered, see the [walkthrough on triggering compaction in Claude Code and Cursor](/library/agentic-ai/compaction-and-summarization).
