...
Context windows are measured in [tokens](/library/large-language-models/what-are-tokens-in-ai), chunks of text usually smaller than a whole word. That measurement matters because [the way LLMs learn](/library/large-language-models/how-llms-work) to process text happens one token at a time, and the window is a hard limit on how many of those tokens fit into a single pass.
