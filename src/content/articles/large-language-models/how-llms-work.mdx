...
If you're not sure where LLMs fit in the broader AI landscape, the [AI family tree](/library/ai-foundations/ai-family-tree) lesson covers that first. Want the pure definition before the mechanism? [What is a large language model](/library/large-language-models/what-is-a-large-language-model) covers that in two minutes.
...
<Note>
  The scale involved is genuinely hard to picture. <a href="https://arxiv.org/abs/2005.14165" target="_blank" rel="noopener noreferrer">GPT-3</a> was trained on roughly 500 billion tokens. The model itself has 175 billion parameters. That scale, not any special magic, is what makes the behavior feel intelligent.
</Note>
...
This is why LLMs can feel like they're thinking through a response step by step, in a sense, they are. Each token shapes what comes next. The response builds itself, each piece influenced by everything before it. You can even nudge a standard model to do more of this out loud, a technique called [chain of thought prompting](/library/prompt-engineering/giving-the-model-room-to-think), though it works differently once a model is built to reason internally.
...
Some systems do add that capability, they can retrieve real information before generating a response. That's a technique called [RAG](/glossary/rag), and it's a separate lesson.
...
What comes after LLMs, giving them tools, memory, and the ability to act in the world, is where [AI agents](/glossary/agent) come in. That's the next direction to explore after this course.
...
<Steps>
  <Step number={1} title="Count your tokens">
    Go to <a href="https://claude.ai" target="_blank" rel="noopener noreferrer">claude.ai</a> or <a href="https://chatgpt.com" target="_blank" rel="noopener noreferrer">chatgpt.com</a>. Type any sentence, whatever comes to mind.
...
<Note>
  Done? You've completed Lesson 01.03.
