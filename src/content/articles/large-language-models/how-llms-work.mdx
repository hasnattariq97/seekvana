...
| Model size | Typical use case | Speed | Cost |
|---|---|---|---|
| Small (7B) | Simple tasks, local deployment | Fast | Low |
| Medium (70B) | Most production tasks | Moderate | Moderate |
| Large (400B+) | Complex reasoning, frontier tasks | Slow | High |
