...
<Steps>
  <Step number={1} title="Place three real AI tools on the family tree">
    Pick three AI tools or features you've used this week, e.g. a spam filter, a Netflix/Spotify recommendation, ChatGPT/Claude, an AI agent, a photo-tagging feature. For each one, write down which of the five levels it belongs to (Machine Learning, Deep Learning, Large Language Models, Generative AI, or Agentic AI) and one sentence explaining why.

    This takes under 5 minutes and forces you to apply the map to tools you actually use, not just the article's examples.
  </Step>
</Steps>
