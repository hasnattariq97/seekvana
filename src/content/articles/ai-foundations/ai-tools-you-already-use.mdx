...
<Note>
 Done? You've completed Lesson 01.07 of the [Getting Started path](/paths/getting-started). Next up: [How to think about AI as a collaborator, not a magic box](/library/ai-foundations/ai-as-collaborator) →
</Note>
