...
## How AI Shows Up in Everyday Apps
...
If you want to go deeper on how recommendation engines like Spotify's actually work, the [Spotify Engineering blog](https://engineering.atspotify.com/2021/12/how-spotify-uses-ml-to-create-the-right-playlist-for-every-moment/) has a clear breakdown. And Apple's [Face ID security documentation](https://support.apple.com/guide/security/face-id-security-sec0a319b9e0/web) explains exactly how the Secure Enclave keeps your face data private.
