...
- 09.01 Project 1: Hello Claude — a Python script that calls the API and prints a response
- 09.02 Project 2: Prompt tester — send three different prompts and compare outputs
- 09.03 Project 3: .env reader — a script that loads credentials securely and confirms they work
- 09.04 Project 4: File summariser — read a .txt file and ask Claude to summarise it
- 09.05 Project 5: Commit log — a git repo with at least five meaningful commits
- 09.06 Project 6: Static webpage — a deployed HTML page with your name and a short bio
- 09.07 Project 7: FastAPI endpoint — a /chat route that accepts a message and returns a Claude response
- 09.08 Project 8: Supabase logger — save every API response to a database table
- 09.09 Project 9: Capstone — a deployed chat interface that calls Claude and logs conversations
